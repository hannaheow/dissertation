...
\clearpage
::: {#table-aim2_table3}
## Table 3: BIC Scores relative to reference for models with and without urbanicity and migration

\vspace{0.2cm}  <!-- Adds a small space after the heading to keep layout clean -->
